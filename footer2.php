 ...
 <footer class="android-footer mdl-mega-footer">
  <div class="mdl-mega-footer--top-section">
    <div class="mdl-mega-footer--left-section">
      <div class="mdl-typography--font-light">CRYPTEX 2019</div>
      <div class="mdl-typography--font-light">Copyright © 2019 CSI DTU</div>
  ...
  <div class="mdl-mega-footer--bottom-section">
    ...
    <a class="android-link mdl-typography--font-light" target="_blank" href="<?php echo FESTSITE;?>" >Visit Invictus Site</a>
