  ...
  <body>
    <div class="mdl-layout mdl-js-layout  mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <script>
        ...
        $("#ls").click(function() {
          // console.log("You have clicked Levelskip Lifeline ");
        ...
        $("#fl").click(function() {
          // console.log("You have clicked on  First-last Lifeline");
        ...
        $("#al").click(function() {
          // console.log("You have clicked on anslen lifeline");
      ...
      <?php
        ...
        if (isset($_SESSION["fb_id"]) && !empty($_SESSION["fb_id"])) {
          ...
          //print_r($level);
          if($level > maxlevel()){
            $congratsLink = REDIRECTLINK."/congrats";
            echo "<script>window.location.href = '".$congratsLink."'</script>";
          }
        ...
        <div class="mdl-grid">
          <div class="demo-card-wide mdl-card mdl-shadow--2dp mdl-cell mdl-cell--10-col mdl-cell--1-offset-desktop mdl-cell--1-offset-tablet">
            ...
            <?php
              ...
              if (isset($row["video"])) {
                $src = $row["video"] ;
                $source = '<div class="video-container">
                            <iframe 
